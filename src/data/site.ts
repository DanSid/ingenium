...
export const HERO = {
  headline: 'Proven strategic intelligence engineered into measurable impact.',
  supporting:
    'For companies expanding across borders and redefining markets, intelligence must be inherent, direction must be precise, execution must be governed, and success must be earned and repeatable.',
  secondary:
